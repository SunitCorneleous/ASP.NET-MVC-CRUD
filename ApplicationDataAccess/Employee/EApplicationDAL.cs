...
namespace ApplicationDataAccess.Employee
{
    public class EApplicationDAL
    {
        string conStringName = "mycon";
        ...
        public List<EmployeeModel> GetAllEmployee()
        {
            ...
            SqlConnection con = new SqlConnection(DBConnection.ConnVal(conStringName));
